...
if(count($arUF["UF_PRICE_LINK_SECT"]['VALUE'])){
	...
	$serv = array();
	$_elems = CIBlockElement::GetList(array('IBLOCK_SECTION_ID'=>'ASC'),array('SECTION_ID'=>$arUF["UF_PRICE_LINK_SECT"]['VALUE'],'IBLOCK_ID'=>13,'ACTIVE'=>'Y'),false,false,array('ID','IBLOCK_ID','SECTION_ID','NAME','PROPERTY_price_premium','PROPERTY_price_odintsovo','PROPERTY_price_zvenigorod'));
