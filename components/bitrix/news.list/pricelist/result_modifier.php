...
while ($pricecat = $_pricecat->GetNext()) {
	$_priceel = CIBlockElement::GetList(array('NAME'=>'ASC', 'SORT'=>'ASC'),array('IBLOCK_ID'=>13,'SECTION_ID'=>$pricecat['ID'],'ACTIVE'=>'Y'),false,false,array('ID','IBLOCK_ID','NAME','PROPERTY_price_premium','PROPERTY_price_odintsovo','PROPERTY_price_zvenigorod'));
