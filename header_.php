...
<head>
	...
	<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/project/js/lib/fancybox/jquery.fancybox.js"></script>
	...
	<div id="feedback-form-place" class="modal-window">
		...
		<div class="form-place">
			<form id="modal-feedback-form" novalidate="novalidate">
				...
				<div class="group">
					<div class="cell">
						<input type="text" placeholder="ФИО" name="feedback_name" data-require="1">
					</div>
					<div class="cell">
				...
				<div class="container">
					<div class="grid">
						<div class="cell-2 logo">
							<? if ($APPLICATION->GetCurDir()!="/") { ?> <a href="/"><?}?><i class="icons-main-logo"></i><? if ($APPLICATION->GetCurDir()!="/") { ?> </a><?}?>
						</div>
						...
						<div class="cell-2 phone">
							...
							<div>
								<a href="javascript:void(0)" class="get-callback"><i class="icons-menu-callback"></i><span>Обратный звонок</span></a>
							</div>
						</div>
					</div>
				</div>
